...
class _injPow {
    ...
    async solvepow() {
        const n = [],
            e = new Blob([this.workerScript], {
                type: "text/javascript"
            }),
            t = URL.createObjectURL(e);
        for (let e = 0; e < 1048576; e += 262144) n.push(new Promise(((n, r) => {
            this.spawnWorker(t, e, Math.min(e + 262144 - 1, 1048575), n, r)
        })));
        try {
            return Promise.any || (Promise.any = function(n) {
                return new Promise(((e, t) => {
                    ...
                    n.forEach(((n, c) => {
                        Promise.resolve(n).then((n => {
                            ...
                            r[c] = n, i -= 1, 0 === i && t(new AggregateError(r, "All promises were rejected"))
                        }))
                    }))
                }))
            }), await Promise.any(n)
