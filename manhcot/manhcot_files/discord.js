			...
			function c(e) {
				...
				return (0, r.jsx)(r.Fragment, {
					children: (0, r.jsx)("div", {
						...
						onClick: () => {
							m(), u(), d.current && (d.current.classList.toggle(a().hide), d.current.style.pointerEvents = "none", setTimeout(() => {
								d.current && (d.current.style.display = "none")
							}, 650)), l === a().fadeUp ? c.current.classList.add(l) : l === a().unfold && document.querySelectorAll(".".concat(a().unfoldStart)).forEach((e, t) => {
								setTimeout(() => {
